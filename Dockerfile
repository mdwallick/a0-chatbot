...
ARG AUTH0_CLIENT_ID_MGMT
ARG AUTH0_CLIENT_SECRET_MGMT
...
ENV AUTH0_CLIENT_ID_MGMT=${AUTH0_CLIENT_ID_MGMT}
ENV AUTH0_CLIENT_SECRET_MGMT=${AUTH0_CLIENT_SECRET_MGMT}
...
RUN echo "--- Debugging Build Environment Variables (builder stage) ---" && \
    ...
    echo "AUTH0_CLIENT_ID_MGMT: $AUTH0_CLIENT_ID_MGMT" && \
    echo "AUTH0_CLIENT_SECRET_MGMT: ${AUTH0_CLIENT_SECRET_MGMT:+yes}" && \
    echo "---------------------------------------------------------"
