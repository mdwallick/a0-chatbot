...
export default function PrivacyPolicyPage() {
  ...
  return (
    ...
    >
      ...
      <p>
        This App is a demonstration of an AI chatbot&apos;s capabilities. Your privacy is important
        to us.
      </p>
      ...
      <ul style={{ marginLeft: "20px" }}>
        <li style={{ marginBottom: "8px" }}>
          ...
          <ul style={{ marginLeft: "20px", marginTop: "5px" }}>
            <li>
              ...
              your email address and a password (if this option is available), we will collect your
              email address.
            </li>
          </ul>
        </li>
        <li style={{ marginBottom: "8px" }}>
          <strong>
            Information from Social Logins (e.g., &quot;Sign in with Google,&quot; &quot;Sign in
            with Microsoft&quot;):
          </strong>
          <ul style={{ marginLeft: "20px", marginTop: "5px" }}>
            <li>
              If you choose to log in using a third-party social identity provider (like Google or
              Microsoft), we will request your consent to access basic profile information from that
              provider. This information is typically limited to:
              <ul style={{ marginLeft: "20px", marginTop: "5px" }}>
            ...
            <li>
              We only receive information that you have explicitly authorized the social provider to
              share with us. We do not collect passwords from your social media accounts.
            </li>
          </ul>
        </li>
        <li style={{ marginBottom: "8px" }}>
      ...
      <ul style={{ marginLeft: "20px" }}>
        <li style={{ marginBottom: "8px" }}>
          <strong>To Provide and Operate the Service:</strong> To allow you to access and use the AI
          chatbot demo.
        </li>
        <li style={{ marginBottom: "8px" }}>
          <strong>To Authenticate You:</strong> To verify your identity when you log in, either via
          email or a social provider.
        </li>
        <li style={{ marginBottom: "8px" }}>
      ...
      <ul style={{ marginLeft: "20px" }}>
        ...
        <li style={{ marginBottom: "8px" }}>
          ...
          obligation, protect and defend our rights or property, prevent fraud, act in urgent
          circumstances to protect the personal safety of users of the Service, or protect against
          legal liability.
        </li>
      </ul>
      ...
      <p>
        ...
        and unauthorized access, disclosure, alteration, and destruction. However, no internet or
        email transmission is ever fully secure or error-free, so you should take special care in
      ...
      <ul style={{ marginLeft: "20px" }}>
        <li style={{ marginBottom: "8px" }}>
          ...
          account (name and email from social login, or just email for direct signup) for as long as
          your account is active with our demo service or as needed to provide you services.
        </li>
        <li style={{ marginBottom: "8px" }}>
      ...
      <ul style={{ marginLeft: "20px" }}>
        <li style={{ marginBottom: "8px" }}>
          ...
          providers through your privacy settings on the respective social media platforms. You can
          also typically disconnect our App via the settings on those platforms.
        </li>
        <li style={{ marginBottom: "8px" }}>
          <strong>Access and Deletion:</strong> If you wish to access, correct, or request deletion
          of the personal information we hold about you (primarily your name and email), please
          contact us at the email address provided below. We will respond to your request within a
      ...
      <p>
        ...
        personal information from individuals under 18. If we become aware that an individual under
        18 has provided us with personal information, we will take steps to delete such information.
      </p>
      ...
      <p>
        ...
        by revising the &quot;Effective Date&quot; at the top of this policy and, in some cases, we
        may provide you with additional notice (such as by adding a statement to our homepage or
        sending you a notification). We encourage you to review the Privacy Policy whenever you
        access the Service to stay informed about our information practices and the choices
        available to you.
      </p>
