...
export default function TermsOfServicePage() {
  ...
  return (
    <>
      ...
      >
        <h1 style={{ textAlign: "center", marginBottom: "30px", fontSize: "1.8em" }}>
        ...
        <p>
          ...
          demonstration purposes only. The features, capabilities, and availability of the Service
          may change or be limited without notice as it is a demonstration application.
        </p>
        ...
        <ul style={{ marginLeft: "20px", paddingLeft: 0 }}>
          <li style={{ marginBottom: "8px" }}>
            Rely on the Service or its output for any critical decisions, including but not limited
            to medical, legal, financial, or safety-critical applications. The AI responses are for
          ...
          <li style={{ marginBottom: "8px" }}>
            Input sensitive personal information (e.g., social security numbers, credit card
            details, health information) into the chatbot.
          </li>
          <li style={{ marginBottom: "8px" }}>
          ...
          <li style={{ marginBottom: "8px" }}>
            Use the Service to generate or disseminate spam, abusive content, or content that
        ...
        <p>
          You are solely responsible for any text, queries, or information you input into the
          Service (&quot;Input&quot;) and for any consequences arising from your use of the Service
          or its output.
        </p>
        ...
        <p>
          You are responsible for any Input you provide to the Service. Do not submit any
          confidential or proprietary information. By using the Service, you understand that your
          Input will be processed by the AI to generate responses. Please refer to our Privacy
          Policy for more information on how we handle data, including Input.
        </p>
        ...
        <p>
          ...
          WITHOUT ANY WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED
        ...
        <p>
          ...
          NOR ITS DIRECTORS, EMPLOYEES, PARTNERS, AGENTS, SUPPLIERS, OR AFFILIATES, BE LIABLE FOR
          ...
          CONDUCT OR CONTENT OF ANY THIRD PARTY ON THE SERVICE; (III) ANY CONTENT OR RESPONSES
